    #Это первое задание 
# world = ["ammerica", "Korea", "Russia", "Kyrgyzstan", "uzdekistan", "BMW", "HONDA", "Nissan", "Toyota", "Ftrrari", "Toska", "Kalimatan", "Mustafa", "99 имена аллаха", "Ajnads"]
# print(world)
# print(world [2:7])
    #Это второе задание
# number = ["1", "2", "3", "4", "5"]
